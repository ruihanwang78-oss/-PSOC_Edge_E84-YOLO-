...
const cy_stc_scb_uart_config_t CYBSP_TENXER_UART_config =
{
...
#if defined (COMPONENT_MTB_HAL)
const mtb_hal_peri_div_t CYBSP_TENXER_UART_clock_ref =
{
...
const mtb_hal_clock_t CYBSP_TENXER_UART_hal_clock =
{
    .clock_ref = &CYBSP_TENXER_UART_clock_ref,
    .interface = &mtb_hal_clock_peri_interface,
};
#endif /* defined (COMPONENT_MTB_HAL) */

#if defined (COMPONENT_MTB_HAL) && (MTB_HAL_DRIVER_AVAILABLE_UART)
const mtb_hal_uart_configurator_t CYBSP_TENXER_UART_hal_config =
{
    .base = CYBSP_TENXER_UART_HW,
    .clock = &CYBSP_TENXER_UART_hal_clock,
    .tx_pin = 2,
...
const cy_stc_tcpwm_counter_config_t CYBSP_GENERAL_PURPOSE_TIMER_2_config =
{
    .period = 4294967295,
    .clockPrescaler = CY_TCPWM_COUNTER_PRESCALER_DIVBY_1,
    .runMode = CY_TCPWM_COUNTER_CONTINUOUS,
    ...
    .captureInputMode = CYBSP_GENERAL_PURPOSE_TIMER_2_INPUT_DISABLED & 0x3U,
    .captureInput = CY_TCPWM_INPUT_0,
    .reloadInputMode = CYBSP_GENERAL_PURPOSE_TIMER_2_INPUT_DISABLED & 0x3U,
    .reloadInput = CY_TCPWM_INPUT_0,
    .startInputMode = CYBSP_GENERAL_PURPOSE_TIMER_2_INPUT_DISABLED & 0x3U,
    .startInput = CY_TCPWM_INPUT_0,
    .stopInputMode = CYBSP_GENERAL_PURPOSE_TIMER_2_INPUT_DISABLED & 0x3U,
    .stopInput = CY_TCPWM_INPUT_0,
    .countInputMode = CYBSP_GENERAL_PURPOSE_TIMER_2_INPUT_DISABLED & 0x3U,
    .countInput = CY_TCPWM_INPUT_1,
    .capture1InputMode = CYBSP_GENERAL_PURPOSE_TIMER_2_INPUT_DISABLED & 0x3U,
    .capture1Input = CY_TCPWM_INPUT_0,
    .compare2 = CY_TCPWM_GRP_CNT_CC0_DEFAULT,
    .compare3 = CY_TCPWM_GRP_CNT_CC0_BUFF_DEFAULT,
    .enableCompare1Swap = false,
...
#if defined (COMPONENT_MTB_HAL)
const mtb_hal_peri_div_t CYBSP_GENERAL_PURPOSE_TIMER_2_clock_ref =
{
    .clk_dst = (en_clk_dst_t)PCLK_TCPWM0_CLOCK_COUNTER_EN2,
    .div_type = CY_SYSCLK_DIV_16_BIT,
    .div_num = 2,
};
const mtb_hal_clock_t CYBSP_GENERAL_PURPOSE_TIMER_2_hal_clock =
{
    .clock_ref = &CYBSP_GENERAL_PURPOSE_TIMER_2_clock_ref,
    .interface = &mtb_hal_clock_peri_interface,
};
#endif /* defined (COMPONENT_MTB_HAL) */

#if defined (COMPONENT_MTB_HAL) && (MTB_HAL_DRIVER_AVAILABLE_TIMER)
const mtb_hal_timer_configurator_t CYBSP_GENERAL_PURPOSE_TIMER_2_hal_config =
{
    .tcpwm_base = CYBSP_GENERAL_PURPOSE_TIMER_2_HW,
    .clock = &CYBSP_GENERAL_PURPOSE_TIMER_2_hal_clock,
    .tcpwm_cntnum = 2U,
};
#endif /* defined (COMPONENT_MTB_HAL) && (MTB_HAL_DRIVER_AVAILABLE_TIMER) */
