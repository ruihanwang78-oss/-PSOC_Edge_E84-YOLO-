...
#define CYBSP_TENXER_UART_ENABLED 1U
#define CYBSP_TENXER_UART_HW SCB1
#define CYBSP_TENXER_UART_IRQ scb_1_interrupt_IRQn
...
#define CYBSP_GENERAL_PURPOSE_TIMER_2_ENABLED 1U
#define CYBSP_GENERAL_PURPOSE_TIMER_2_HW TCPWM0
#define CYBSP_GENERAL_PURPOSE_TIMER_2_NUM 2UL
...
extern const cy_stc_scb_uart_config_t CYBSP_TENXER_UART_config;

#if defined (COMPONENT_MTB_HAL)
extern const mtb_hal_peri_div_t CYBSP_TENXER_UART_clock_ref;
extern const mtb_hal_clock_t CYBSP_TENXER_UART_hal_clock;
#endif /* defined (COMPONENT_MTB_HAL) */

#if defined (COMPONENT_MTB_HAL) && (MTB_HAL_DRIVER_AVAILABLE_UART)
extern const mtb_hal_uart_configurator_t CYBSP_TENXER_UART_hal_config;
...
extern const cy_stc_tcpwm_counter_config_t CYBSP_GENERAL_PURPOSE_TIMER_2_config;

#if defined (COMPONENT_MTB_HAL)
extern const mtb_hal_peri_div_t CYBSP_GENERAL_PURPOSE_TIMER_2_clock_ref;
extern const mtb_hal_clock_t CYBSP_GENERAL_PURPOSE_TIMER_2_hal_clock;
#endif /* defined (COMPONENT_MTB_HAL) */

#if defined (COMPONENT_MTB_HAL) && (MTB_HAL_DRIVER_AVAILABLE_TIMER)
extern const mtb_hal_timer_configurator_t CYBSP_GENERAL_PURPOSE_TIMER_2_hal_config;
#endif /* defined (COMPONENT_MTB_HAL) && (MTB_HAL_DRIVER_AVAILABLE_TIMER) */
