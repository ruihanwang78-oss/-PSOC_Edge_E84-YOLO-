...
SEARCH_camera-dvp-ov7675=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/camera-dvp-ov7675/release-v0.5.1
...
SEARCH_emusb-host=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/emusb-host/release-v2.2.0
SEARCH_freertos=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/freertos/release-v10.6.202
SEARCH_ml-middleware=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/ml-middleware/release-v3.3.0
SEARCH_ml-tflite-micro=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/ml-tflite-micro/release-v3.3.0
SEARCH_retarget-io=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/retarget-io/release-v1.9.0
SEARCH_serial-memory=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/serial-memory/release-v3.2.0
...
SEARCH_MTB_MK+=$(SEARCH_camera-dvp-ov7675)
...
COMPONENTS += MW_CAMERA_DVP_OV7675
...
CY_HELP_deepcraftmodelconverter=Launches the DEEPCRAFT™ Model Converter 5.9 GUI for the target's byom file
CY_HELP_deepcraftmodelconverter_VERBOSE=Launches the DEEPCRAFT™ Model Converter 5.9 GUI. Check the DEEPCRAFT™ Model Converter 5.9 User Guide for more information.
