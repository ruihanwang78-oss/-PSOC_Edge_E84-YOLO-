...
SEARCH_lwip-freertos-integration=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/lwip-freertos-integration/release-v1.3.0
...
SEARCH_whd-bsp-integration=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/whd-bsp-integration/release-v2.6.0
...
SEARCH_wifi-host-driver=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/wifi-host-driver/release-v5.3.1
